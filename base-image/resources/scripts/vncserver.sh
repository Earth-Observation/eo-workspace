...
VNC_DISPLAY_ID=$DISPLAY
VNC_COL_DEPTH=24
VNC_ROOT_DIR="$RESOURCES_PATH/vnc"
...
startInBackgroundIfNotRunning "VNC Password" sudoUserIf "echo "$VNC_PW" | /opt/TurboVNC/bin/vncpasswd -f >> $HOME/.vnc/passwd"
startInBackgroundIfNotRunning "TurboVNC" sudoUserIf "chmod 600 $HOME/.vnc/passwd"
...
# startInBackgroundIfNotRunning "xfce4-session" sudoUserIf "dbus-launch xfce4-session"
