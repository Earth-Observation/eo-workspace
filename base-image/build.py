...
parser.add_argument(
    "--name", help="base name of docker container", default="eo-workspace"
)
parser.add_argument(
...
parser.add_argument(
    "--flavor", help="flavor (base) used for docker container", default="base"
)
...
def build(module="."):
    ...
    full_command = (
        "cd " + module + " && " + build_command + " && cd " + working_dir
    )
